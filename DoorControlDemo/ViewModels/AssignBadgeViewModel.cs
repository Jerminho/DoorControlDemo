...
namespace DoorControlDemo.ViewModels
{
    public class AssignBadgeViewModel : ViewModelBase
    {
        ...
        public void AssignBadgeButton()
        {
            ...
            //MessageBox.Show(dbContext.Badges.First(b => b.BadgeId == 1));

            /*user = dbContext.Users.First(u => (u.UserId.ToString() == _userId));
            badge = dbContext.Badges.First(b => b.BadgeId == _badgeId);*/
